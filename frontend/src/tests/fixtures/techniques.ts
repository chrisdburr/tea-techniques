...
export const mockAssuranceGoals = [
  ...
  },
  {
    id: 2,
    name: "Fairness",
    description: "Techniques for ensuring equitable AI outcomes",
  },
  {
    id: 3,
    name: "Privacy",
    description: "Techniques for protecting data privacy in AI systems",
  },
  {
    id: 4,
    name: "Reliability",
    description: "Techniques for ensuring consistent AI performance",
  },
  {
    id: 5,
    name: "Safety",
    description: "Techniques for preventing harmful AI behavior",
  },
  {
    id: 6,
    name: "Transparency",
    description: "Techniques for making AI processes visible",
  },
];
...
export const mockTechniques = [
    ...
    resources: [
      {
        ...
        description:
          "Original SHAP paper introducing the unified framework for feature attribution",
    ...
    example_use_cases: [
      {
        id: 1,
        description:
          "Analyzing a customer churn prediction model to understand why a specific high-value customer was flagged as likely to leave, revealing that recent support ticket interactions and declining purchase frequency were the main drivers.",
    ...
    resources: [
      {
        ...
        description:
          "Original LIME paper introducing model-agnostic local explanations",
    ...
    example_use_cases: [
      {
        id: 3,
        description:
          "Explaining why a medical diagnosis model classified a particular X-ray as showing signs of pneumonia, highlighting the specific regions and features that influenced the decision.",
        assurance_goal: mockAssuranceGoals[0], // Explainability
      },
    ],
    limitations: [
      {
        id: 3,
        description:
          "Local explanations may not be representative of the global model behavior, potentially missing important patterns that occur in other regions of the feature space.",
      },
    ],
  ...
  },
  {
    ...
    acronym: "",
    description:
      "Differential privacy provides a mathematical framework for measuring and controlling privacy loss when analyzing datasets. It ensures that the inclusion or exclusion of any single individual's data does not significantly affect the outcome of any analysis, providing strong privacy guarantees.",
    complexity_rating: 4,
    ...
    resources: [
      {
        ...
        description:
          "Foundational paper on differential privacy by Cynthia Dwork",
    ...
    example_use_cases: [
      {
        id: 4,
        description:
          "Training a machine learning model on sensitive medical data while ensuring that individual patient records cannot be reconstructed or inferred from the trained model.",
    ...
    limitations: [
      {
        id: 4,
        description:
          "Adding noise to preserve privacy can reduce the accuracy and utility of the resulting analysis or model predictions.",
      },
    ],
    related_techniques: [],
  },
...
export const mockEdgeCaseTechniques = [
  {
    ...
    description:
      "A" +
      "very ".repeat(200) +
      "long description that tests how components handle extremely lengthy text content and whether proper truncation or wrapping occurs.",
    complexity_rating: 5,
  ...
  },
  {
    ...
    acronym: "",
    description:
      "This technique tests handling of unicode characters, special symbols, and emojis in the interface.",
    complexity_rating: 1,
    computational_cost_rating: 1,
...
export const createMockTechnique = (
  ...
  ({
    ...
    ...overrides,
    slug:
      overrides.slug || `test-technique-${Math.floor(Math.random() * 10000)}`, // Ensure unique slug
  }) as Technique;

export const createMockTechniquesList = (
