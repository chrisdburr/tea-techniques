      ...
      <div className="space-y-8 py-4">
        <section>
          ...
          <div className="prose max-w-none bg-card rounded-lg p-6 border shadow-sm">
            <p>
              The TEA Techniques Database is an interactive repository designed
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  that work across different model types or that are designed
      ...
      <div className="space-y-8 py-4">
          ...
          <div className="bg-card rounded-lg border shadow-sm p-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <strong>Through the UI</strong>: Once logged in with
                  appropriate permissions, you can use the &quot;Add New
                  Technique&quot; form.
                </div>
              </li>
              <li className="flex items-start gap-2">
                ...
                <div>
                  <strong>Via JSON modifications</strong>: The backend includes
                  a directory where the dataset is stored as a single JSON file,
            ...
            <p className="mt-4">
              When adding a new technique, please ensure you provide
        ...
        <section>
          ...
          <div className="bg-card rounded-lg border shadow-sm p-6">
            ...
            <p className="mt-4">
              We aim to create a welcoming and productive community that
              advances the field of responsible AI development.
            </p>
          </div>
        </section>
      </div>
