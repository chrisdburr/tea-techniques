...
function RelatedTechniques({ techniqueSlugs }: { techniqueSlugs: string[] }) {
      ...
      <MainLayout>
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-muted-foreground mb-8">
            There was an error loading this technique. It may not exist or you
