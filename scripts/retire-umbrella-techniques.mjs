/**
 * Retire umbrella techniques from the dataset.
 *
 ...
 *
 * Usage: node scripts/retire-umbrella-techniques.mjs [--dry-run]
 */
...
// Umbrella techniques to retire, mapped to their preferred replacement children
...
// biome-ignore lint/suspicious/noConsole: CLI script
console.log(`Retiring ${retiredSlugs.size} umbrella techniques\n`);
...
// biome-ignore lint/suspicious/noConsole: CLI script
console.log(
  `Removed ${removed} umbrella techniques (${before} → ${remaining.length})`
);
