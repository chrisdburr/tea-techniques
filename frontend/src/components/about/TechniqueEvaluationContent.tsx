		...
		<div className="space-y-8 py-4">
			<section>
				...
				<div className="prose max-w-none bg-card rounded-lg p-6 border shadow-sm space-y-6">
					<p>
						This document outlines the criteria used to evaluate and select techniques for inclusion in the 
						Trustworthy and Ethical Assurance (TEA) Techniques database. The goal is to create a curated, 
						high-quality resource that helps practitioners build robust assurance cases for their AI systems.
					</p>
					...
					<div className="space-y-4">
						...
						<p>
							...
							TEA goals such as Explainability, Fairness, Privacy, Reliability, Safety, and Transparency.
						</p>
					</div>
							...
							{[
								{
									...
									description: "Does the technique directly address one or more core TEA goals (Explainability, Fairness, Privacy, Reliability, Safety, Transparency)?"
								},
								{
									title: "Nature of Evidence Provided",
									description: "What kind of output does the technique produce (quantitative metrics, visualizations, reports, formal proofs)?"
								},
								{
									title: "Applicability & Scope",
									description: "Model dependency, data type compatibility, lifecycle stage, and scope of explanation/analysis."
								},
								{
									title: "Maturity and Validity",
									description: "Is the technique well-established in research or practice? Is there empirical or theoretical evidence supporting its effectiveness?"
								},
								{
									title: "Practicality & Resource Requirements",
									description: "Complexity, computational cost, data requirements, and expertise needed for implementation."
								},
								{
									title: "Interpretability & Actionability",
									description: "How easy is it for stakeholders to understand the technique's output and translate results into actionable steps?"
								},
								{
									title: "Limitations and Assumptions",
									description: "Are the known limitations, weaknesses, and underlying assumptions well-documented?"
								},
								{
									title: "Availability of Tooling & Resources",
									description: "Are there readily available software libraries, implementations, or detailed tutorials?"
								}
							].map((criterion, index) => (
								<div key={index} className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
									...
									<div>
										<h4 className="font-semibold text-primary mb-1">{criterion.title}</h4>
