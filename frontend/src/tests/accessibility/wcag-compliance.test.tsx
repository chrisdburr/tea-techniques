...
const TechniqueCard = ({ technique }: { technique: Technique }) => (
  <article role="article" aria-labelledby={`technique-${technique.slug}-title`}>
    ...
    {technique.acronym && (
      <span aria-label={`Acronym: ${technique.acronym}`}>
        ({technique.acronym})
      </span>
    )}
        ...
        {technique.assurance_goals.map((goal) => (
          <li key={goal.id}>
            <span
              ...
              role="img"
              aria-label={`Assurance goal: ${goal.name}`}
            >
              {goal.name}
            </span>
          </li>
...
const TechniquesList = ({ techniques }: { techniques: Technique[] }) => (
  <main>
      ...
      <fieldset>
        ...
        <div className="filter-group">
          ...
          <select
            ...
            aria-describedby="complexity-filter-help"
          >
          ...
          <div id="complexity-filter-help" className="sr-only">
            Filter techniques by implementation complexity from 1 (simple) to 5
            (complex)
          </div>
        </div>
      </fieldset>
    ...
    <section aria-label="Techniques results">
      ...
      <div role="list" aria-label="Techniques list" className="techniques-grid">
    ...
    <form aria-label="Technique creation form">
      <fieldset>
        ...
        <div className="form-group">
          ...
          <div id="description-help" className="help-text">
            Provide a detailed description of what the technique does and how it
            works
          </div>
        </div>
      </fieldset>
      ...
      <fieldset>
        ...
        <div className="form-group">
          ...
          <select id="cost-rating" required aria-describedby="cost-help">
...
describe("WCAG 2.1 AA Compliance", () => {
  describe("TechniqueCard Component", () => {
    ...
    it("provides meaningful labels for complex information", () => {
      ...
      const complexityLabel = container.querySelector(
      ...
      if (technique.acronym) {
        const acronymLabel = container.querySelector(
          `[aria-label="Acronym: ${technique.acronym}"]`,
        );
  ...
  describe("TechniquesList Component", () => {
    ...
    it("provides proper list semantics", () => {
      ...
      const list = container.querySelector(
        '[role="list"][aria-label="Techniques list"]',
      );
  ...
  describe("TechniqueForm Component", () => {
    ...
    it("provides helpful descriptions for form fields", () => {
      ...
      expect(container.textContent).toContain(
        "Rate how difficult it is to implement",
      );
    });
