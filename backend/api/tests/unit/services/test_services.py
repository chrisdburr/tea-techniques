...
class TechniqueServiceTests(TransactionTestCase):
    ...
    def test_update_technique_basic_fields(self):
        ...
        self.assertEqual(updated_technique.id, technique.id)  # Same instance
    ...
    def test_transaction_rollback_on_create_error(self):
        ...
        with patch.object(self.service, '_create_nested_objects', side_effect=Exception("Nested error")):
            validated_data = {
                'name': 'Test Technique',
                'description': 'Test description',
            }
...
class TechniqueLimitationServiceTests(TestCase):
    ...
    def test_replace_limitations(self):
        ...
        new_limitations_data = [
            'New limitation 1',
            {'description': 'New limitation 2'}
        ]
        ...
        self.assertFalse(
            TechniqueLimitation.objects.filter(id__in=[existing1_id, existing2_id]).exists()
        )
