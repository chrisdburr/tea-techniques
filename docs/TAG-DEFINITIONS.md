...
*Example:* `assurance-goal-category/explainability/feature-analysis/importance-attribution`, `assurance-goal-category/fairness/group/statistical-parity`
...
*Example:* `applicable-models/cnn`, `applicable-models/agnostic`
...
*Example:* `lifecycle-stage/model-development/training`, `lifecycle-stage/system-deployment-and-use/monitoring`
...
*Example:* `expertise-needed/statistics`, `expertise-needed/domain-knowledge`
...
*Example:* `evidence-type/visualization`, `evidence-type/quantitative-metric`, `evidence-type/qualitative-report`
...
*Example:* `data-requirements/labelled-data`, `data-requirements/access-to-model-internals`
...
*Example:* `explanatory-scope/local`
...
*Example:* `fairness-approach/group`
...
*Example:* `data-type/tabular`, `data-type/text`
...
*Example:* `technique-type/algorithmic`, `technique-type/documentation`
